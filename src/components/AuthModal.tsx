                            ...
                            <div className="flex-1 h-1/2 md:h-full md:w-1/2 p-6 sm:p-8 md:p-10 flex flex-col justify-center relative">
                                ...
                                <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
                                    ...
                                    <div className="hidden md:flex justify-center gap-3 mt-4">
                                        ...
                                        <button type="button" aria-label="Sign in with Google" className="flex-1 py-2.5 bg-slate-800/50 hover:bg-slate-800 text-slate-300 hover:text-white transition-all rounded-xl border border-slate-700/50 hover:border-slate-600 flex items-center justify-center group">
                                        ...
                                        <button type="button" aria-label="Sign in with GitHub" className="flex-1 py-2.5 bg-slate-800/50 hover:bg-slate-800 text-slate-300 hover:text-white transition-all rounded-xl border border-slate-700/50 hover:border-slate-600 flex items-center justify-center group">
                                            <svg className="w-5 h-5 group-hover:scale-110 transition-transform duration-200" fill="currentColor" viewBox="0 0 24 24">

...
import { Building2, X, UserCheck, UserPlus, Mail, Lock, User, ArrowRight, Eye, EyeOff, Loader2 } from 'lucide-react';
                                ...
                                <form className="space-y-4" onSubmit={handleSignIn}>
                                    ...
                                    <div className="pt-2">
                                        <button
                                            type="submit"
                                            disabled={isLoading}
                                            className="w-full bg-gradient-to-r from-blue-600 to-blue-500 hover:from-blue-500 hover:to-blue-400 text-white font-medium rounded-xl py-3.5 transition-all shadow-[0_0_20px_rgba(59,130,246,0.3)] hover:shadow-[0_0_25px_rgba(59,130,246,0.5)] flex items-center justify-center gap-2 group active:scale-[0.98] disabled:opacity-70 disabled:cursor-not-allowed"
                                        >
                                    ...
                                    <div className="hidden md:flex justify-center gap-3 mt-4">
                                        {/* Social Buttons */}
                                        <button type="button" onClick={() => handleOAuth('google')} aria-label="Sign in with Google" className="flex-1 py-2.5 bg-slate-800/50 hover:bg-slate-800 text-slate-300 hover:text-white transition-all rounded-xl border border-slate-700/50 hover:border-slate-600 flex items-center justify-center group">
                                        ...
                                        <button type="button" onClick={() => handleOAuth('facebook')} aria-label="Sign in with Facebook" className="flex-1 py-2.5 bg-slate-800/50 hover:bg-slate-800 text-slate-300 hover:text-[#1877F2] transition-all rounded-xl border border-slate-700/50 hover:border-slate-600 flex items-center justify-center group">
                                        ...
                                        <button type="button" onClick={() => handleOAuth('twitter')} aria-label="Sign in with X" className="flex-1 py-2.5 bg-slate-800/50 hover:bg-slate-800 text-slate-300 hover:text-white transition-all rounded-xl border border-slate-700/50 hover:border-slate-600 flex items-center justify-center group">
                                            <svg className="w-[18px] h-[18px] group-hover:scale-110 transition-transform duration-200" fill="currentColor" viewBox="0 0 24 24">
                                                <path d="M18.244 2.25h3.308l-7.227 8.26 8.502 11.24H16.17l-5.214-6.817L4.99 21.75H1.68l7.73-8.835L1.254 2.25H8.08l4.713 6.231zm-1.161 17.52h1.833L7.084 4.126H5.117z" />
                                            </svg>
                                        </button>
                                        <button type="button" onClick={() => handleOAuth('github')} aria-label="Sign in with GitHub" className="flex-1 py-2.5 bg-slate-800/50 hover:bg-slate-800 text-slate-300 hover:text-white transition-all rounded-xl border border-slate-700/50 hover:border-slate-600 flex items-center justify-center group">
                                            <svg className="w-5 h-5 group-hover:scale-110 transition-transform duration-200" fill="currentColor" viewBox="0 0 24 24">
